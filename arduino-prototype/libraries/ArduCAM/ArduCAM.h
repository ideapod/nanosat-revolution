...
class ArduCAM
{
    ...
    inline void setDataBits(uint16_t bits);
		...
		void diagnosticsOn();
		void diagnosticsOff();
		void diagmsg(char *msg);
		void diagBusMsg(char *msg, int address, int value);
		void diagReadBusMsg(int address, int value);
		void diagWriteBusMsg(int address, int value);
